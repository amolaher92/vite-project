<template>
  <section class="w-full container mx-auto border place-content-center my-5 py-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:px-8">
      ...
      <div class="p-4 border space-y-8">
